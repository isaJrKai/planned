...
// GET /api/admin/sessions — list all sessions for the current founder
...
// POST /api/admin/sessions — revoke sessions
// Body: { sessionId?: string, all?: boolean }
//   - If sessionId provided: revoke that single session (TEST 5 — revoke browser B)
//   - If all=true: revoke ALL the founder's sessions (logout everywhere)
